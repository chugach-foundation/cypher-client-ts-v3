...
type _OrdersAccountState = TypeDef<Cypher['accounts'][6], Cypher>;
export type PoolNodeState = TypeDef<Cypher['accounts'][7], Cypher>;
type _Pool = TypeDef<Cypher['accounts'][8], Cypher>;
export type PriceHistory = TypeDef<Cypher['accounts'][9], Cypher>;
type _CypherAccount = TypeDef<Cypher['accounts'][10], Cypher>;
type _CypherSubAccount = TypeDef<Cypher['accounts'][11], Cypher>;
