...
export type TransferBetweenSubAccountsLog = Event<Cypher['events'][10]>;
export type OrderFillLog = Event<Cypher['events'][11]>;
export type FundingPaymentLog = Event<Cypher['events'][12]>;
